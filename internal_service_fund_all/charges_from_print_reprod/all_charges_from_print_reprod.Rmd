...
```{r}
ISF_health_insurance_fund_charges_from_print_reprod_2017 <- df_06_health_insurance_fund[18:19, 1:2]
```
...
#Rename first column
```{r}
names(all_charges_from_print_reprod_2017)[1] <- 'claims_refunds_maintenance_2017'
names(all_charges_from_print_reprod_2017)[2] <- 'Health Insurance Fund'
...
#Create file
```{r}
write.csv(all_charges_from_print_reprod_2017,"all_charges_from_print_reprod_2017.csv")
```
